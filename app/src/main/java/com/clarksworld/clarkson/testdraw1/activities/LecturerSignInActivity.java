...
public class LecturerSignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(LecturerSignInActivity.this, BaseActivity.class));
            finish();
        }
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LecturerSignInActivity.this, SignUpActivity.class);
...
//        });
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(LecturerSignInActivity.this, ResetPasswordActivity.class));
            }
        });
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //authenticate user
                auth.signInWithEmailAndPassword(email, password).addOnCompleteListener(LecturerSignInActivity.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            if (password.length() < 6) {
                                ...
                                Toast.makeText(LecturerSignInActivity
                                        .this, getString(R.string.auth_failed), Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Intent intent = new Intent(LecturerSignInActivity.this, BaseActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    }

...
//    EditText email, password;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lecturerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SignInActivity.this, LecturerSignInActivity.class);
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SignInActivity.this, UserSignupAuthActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void firstUser() {
        ...
        if (email.equals(matNum) && password.equals(password8)) {
            ...
            Toast.makeText(SignInActivity.this, "invalid Email Address," + " or incorrect password check and try again", Toast.LENGTH_SHORT).show();
        }
